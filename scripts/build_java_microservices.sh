...
for service in data-plane control_plane-java admin-java graph-builder graoh_composer; do
...
for service in data-plane control_plane-java task_executor-java plan_executor-java; do
